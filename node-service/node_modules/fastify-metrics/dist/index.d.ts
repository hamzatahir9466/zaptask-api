 ...
 */
import type { IFastifyMetrics, IMetricsPluginOptions, IMetricsRouteContextConfig } from 'fastify-metrics/src/types';
...
export * from 'fastify-metrics/src/types';
/**
 * Metric plugin
 *
 * @example
 ...
 * ```
 */
declare const _default: import("fastify").FastifyPluginCallback<Partial<IMetricsPluginOptions>, import("fastify").RawServerDefault, import("fastify").FastifyTypeProviderDefault, import("fastify").FastifyBaseLogger>;
